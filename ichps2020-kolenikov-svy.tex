...
References: http://www.citeulike.org/user/ctacmo/tag/ichps2020
...
\begin{frame}\frametitle{Some thoughts on causal inference}

Randomized controlled trials: 
\begin{enumerate}
    \item Maintain the wall between control and treatment(s) groups
\end{enumerate}
