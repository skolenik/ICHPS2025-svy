...
\institute[NORC]{NORC \\ \medskip Views and opinions are those of the instructor only, \\ not those of NORC or ASA}

% redefine beamer colors

\logo{\includegraphics[height=0.6cm]{NORCLogo_Short_Color}}
